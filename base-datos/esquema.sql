...
-- Hosting Spaceship: la base ya existe en el panel, no uses CREATE DATABASE.
-- Importar en phpMyAdmin o: mysql -u usuario -p nzoaqaxydg_zonagrupos_db < esquema.sql
--
-- Local (Node): crea la BD manualmente o con npm run setup-db y usa BD_NOMBRE en config.env
